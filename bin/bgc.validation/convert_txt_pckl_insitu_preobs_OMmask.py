...
def main(folder,year1,year2):
   ...
   f=open('/nird/projects/NS9481K/BGC.Validation/OMmaskTP2.pckl','rb')
   REGmaskTP2 = pickle.load(f,encoding="latin1")
   f.close()
   f=open('/nird/projects/NS9481K/BGC.Validation/OMmaskTP5.pckl','rb')
   REGmaskTP5 = pickle.load(f,encoding="latin1")
   f.close()
   f=open('/nird/projects/NS9481K/BGC.Validation/OMmaskTP0.pckl','rb')
