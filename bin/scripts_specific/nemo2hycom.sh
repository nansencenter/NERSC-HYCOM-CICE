...
HYCOM_ALL="/nird/home/bjornb/NERSC-HYCOM-CICE/hycom/hycom_ALL/hycom_2.2.72_ALL"
#
iexpt=10
iversn=22
yrflag=3
idm=$(egrep "'idm   ' = longitudinal array size" ../topo/regional.grid.b | head -n1 | awk '{print $1;}')
jdm=$(egrep "'jdm   ' = latitudinal  array size" ../topo/regional.grid.b | head -n1 | awk '{print $1;}')
#
#
#
