...
def main(path,sigma,months,resolution) :
   ...
   if resolution == 0.25 :
      ...
      fnametemplate="woa18_decav_%s%02d_04.nc" # 0.25 degrees
   else :
      #fnametemplate="woa13_decav_%s%02d_01v2.nc" # 1.00 degrees
      fnametemplate="woa18_decav_%s%02d_01.nc" # 1.00 degrees
   ...
   for month in months :
      ...
      if dump_netcdf :
         fname_out_nc = "extrapolated_WOA2018_m%02d.nc"%(month + 1)
      ...
      stitle="WOA 2018 Stable Salinity, %s"%monthname
      ttitle="WOA 2018 Stable Pot. Temp, %s"%monthname
      rtitle="WOA 2018 Stable Density, %s"%monthname
...
if __name__ == "__main__" :
   ...
   parser.add_argument('path',help="Directory where WOA18 netcdf files are present")
