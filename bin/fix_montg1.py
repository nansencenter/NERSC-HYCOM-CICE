...
def main(archv_files,regress_file,opath,depth_file) :
#,header_line1=None,header_line2=None,header_line3=None ) :
   ...
   for archv_file in archv_files :
      ...
      header_line1=arcfile._header[0]
      header_line2=arcfile._header[1]
      header_line3=arcfile._header[2]
...
#      logger.info("Estimated montg1 ")
      ...
      arcfile_out=abfile.ABFileArchv(fnameout,"w",iversn=iversn,yrflag=yrflag,iexpt=iexpt,idm=idm,jdm=jdm,mask=False,cline1=header_line1,cline2=header_line2,cline3=header_line3)
...
if __name__ == "__main__" :
   ...
   #parser.add_argument('--header_line1',          type=str, help="First header line, applicable only for archm & archv",default=None)
   #parser.add_argument('--header_line2',          type=str, help="Montgomery with or without barotropic pressure",default=None)
   #parser.add_argument('--header_line3',          type=str, help="Montgomery with or without barotropic pressure",default=None)
   ...
   main(args.archive_file,args.opath,args.regress_file,args.depth_file)
#,header_line1=args.header_line1,header_line2=args.header_line2,header_line3=args.header_line3)
