...
river_synoptic.sh | It can be used to create the high-frequency rifer flux (abfile every 6 hours), and its usage can be found in the relevant README under bin/river-topaz.
