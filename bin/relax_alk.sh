...
for MM in   01 02 03 04 05 06 07 08 09 10 11 12 ; do
   ...
   ${pget} ${BASEDIR}/relax/$CLIM/alks_sig${KSIGMA}_m${MM}.b fort.71  || { echo "Couldnt get z-climatology" ; exit 1 ;}
   ${pget} ${BASEDIR}/relax/$CLIM/alks_sig${KSIGMA}_m${MM}.a fort.71A || { echo "Couldnt get z-climatology" ; exit 1 ;}
   ...
   # --- Output.
   #
   mv fort.10  relax_alk_m${MM}.b
   mv fort.10A relax_alk_m${MM}.a
...
#
cp relax_alk_m01.b relax.CO2_alk.b
#
for  MM  in  02 03 04 05 06 07 08 09 10 11 12 ; do
  tail -n +6 relax_alk_m${MM}.b >> relax.CO2_alk.b
done
#
cp relax_alk_m01.a relax.CO2_alk.a
#
for MM in  02 03 04 05 06 07 08 09 10 11 12 ; do
  cat relax_alk_m${MM}.a >> relax.CO2_alk.a
done
# CAGLAR: In 2023, we switched using PML CO2 to ERSEM CO2
#         Thus CO2_alk variable changed to CO2_TA
#         The code is the same, only the filename changed in relax forder
${pput} relax.CO2_alk.b ${D}/relax.CO2_TA.b
${pput} relax.CO2_alk.a ${D}/relax.CO2_TA.a
#
# --- delete the monthly files
#
/bin/rm relax_alk_m??.[ab]
#C
