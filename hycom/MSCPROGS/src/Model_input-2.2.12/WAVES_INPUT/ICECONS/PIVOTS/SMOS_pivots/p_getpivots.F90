...
! --- TODO: add input argument for the wam data and grid data, read glon,glat,nlon,nlat
 ...
 !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
      ...
      character(len=*), parameter :: out_str    = 'Pivot positions in SMOS related to model grid   '

      !! Names of output files;
      character(len=*), parameter :: filenamea  = 'pivots_smos.a'
      character(len=*), parameter :: filenameb  = 'pivots_smos.b'

      !! Location and name of a file with lon/lat of input data points
      character(len=*), parameter :: d_path  = '/work/shared/nersc/msc/SMOS/Feb2011/'!!path of input data file
      character(len=*), parameter :: d_name  = 'LongitudeLatitudeGrid-SMOS-Arctic.nc'!!local name of any input data file containing lon/lat

      !! Hardcoded grid sizes in data nc files 
      integer, parameter :: nlon=608, nlat=896
