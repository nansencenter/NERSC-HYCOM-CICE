...
dname       = 'amsre';
dpath       = '/work/shared/nersc/msc/AMSRE6.25km/netcdf/';%%path of input data file
ncfil        = [dpath 'LongitudeLatitudeGrid-n6250-Arctic.nc'];%%full name of input file with data lon/lat
ncfil2       = [dpath 'asi-n6250-' cal_date '-v5i.nc'];%%full name of input file with data
