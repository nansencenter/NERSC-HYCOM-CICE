...
! --- TODO: add input argument for the wam data and grid data, read glon,glat,nlon,nlat
 ...
 !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
      ...
      character(len=*), parameter :: out_str    = 'Pivot positions in WAMNSEA related to model grid   '

      !! Names of output files;
      character(len=*), parameter :: filenamea  = 'pivots_wamnsea.a'
      character(len=*), parameter :: filenameb  = 'pivots_wamnsea.b'

      !! Location and name of a file with lon/lat of input data points
      character(len=*), parameter :: d_path  = '/work/shared/nersc/msc/WAMNSEA/2012/analysis/'!!path of input data file
      character(len=*), parameter :: d_name  = 'wam_nsea.an.20120228.nc'!!local name of any input data file containing lon/lat
