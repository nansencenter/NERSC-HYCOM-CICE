...
! --- TODO: add input argument for the wam data and grid data, read glon,glat,nlon,nlat
 ...
 !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
      ...
      character(len=*), parameter :: out_str    = 'Pivot positions in WW3 related to model grid   '

      !! Names of output files;
      character(len=*), parameter :: filenamea  = 'pivots_ww3.a'!final name will be ${MODEL}_pivots_ww3.a (output renamed in RUN_HERE/get_pivots.sh)
      character(len=*), parameter :: filenameb  = 'pivots_ww3.b'!final name will be ${MODEL}_pivots_ww3.b (output renamed in RUN_HERE/get_pivots.sh)

      !! Location and name of a file with lon/lat of input data points
      character(len=*), parameter :: d_path  = '/work/shared/nersc/msc/WAVES_INPUT/WW3/2010/'!!path of input data file
      character(len=*), parameter :: d_name  = 'ww3.201001_hs.nc'!!local name of any input data file containing lon/lat

      !! Hardcoded grid sizes in data nc files 
      integer, parameter :: nlon=720, nlat=317
...
! --- input data dimension and lon,lat
      real :: vlat(nlat), vlon(nlon)!vectors of lon/lat;
