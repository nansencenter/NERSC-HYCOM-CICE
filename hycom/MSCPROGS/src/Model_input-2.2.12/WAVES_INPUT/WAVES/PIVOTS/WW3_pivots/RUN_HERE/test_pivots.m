...
wave_dt0    = 3;%h
wave_dt     = wave_dt0/24;
test_day    = 7*wave_dt;%%NB starts from 0
irec        = 1+round(test_day/wave_dt);

var_name    = 'hs';
dname       = 'ww3';
dpath       = '/work/shared/nersc/msc/WAVES_INPUT/WW3/';%%path of input data file
ncfil       = [dpath test_year{2} '/ww3.' test_year{2} test_mon{2} '_' var_name '.nc'];%%full name of input file with data lon/lat 
ncfil2      = ncfil;
...
if test_xtra_vars
   ...
   for j=1:Nv%%check values of other variables at (itest,jtest)
      ...
      ncfil3{j}   = [dpath test_year{2} '/ww3.' test_year{2} test_mon{2} '_' var_name2{j} '.nc'];
   end
end
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
d_lat_name  = 'latitude';
rank_lonlat = 1;%%rank of lon/lat fields (1 or 2);
