...
c      write(2, '(10f8.1)')(dlon(i),i=1,nxd)
c      write(2,*)
c      write(2, '(10f8.1)')(dlat(i),i=1,nyd)
c      write(2,*)
c      write(2, '(25f5.1)')((mlat(i,j),i=1,25),j=1,nym) 
c      write(2,*)
c      write(2, '(25f5.1)')((mlat(i,j),i=26,nxm),j=1,nym) 
c      write(2,*)
c      write(2, '(25f5.0)')((mlon(i,j),i=1,25),j=1,nym) 
c      write(2,*)
c      write(2, '(25f5.0)')((mlon(i,j),i=26,nxm),j=1,nym) 
...
c      yds  = 90. 
c      DO i=1,nxm
c        IF(mlat(i,1).LT.ymsm)THEN
c         id=i
c         ymsm = mlat(i,1)
c        ENDIF
c      ENDDO 
c      ymsm=ymsm-(mlat(id,2)-ymsm+2.)  !Southern limit for search
