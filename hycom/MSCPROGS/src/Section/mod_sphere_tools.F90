...
contains
   ...
   function secangle(lon1,lat1,lon2,lat2)
      ...
      real, dimension(3) :: nx, n2, ny,crs
      real :: cos1, cos2
      real :: secangle,sgn
      real, parameter :: epsiloon=1e-8
      ...
      nx=nx/(norm2(nx,3)+epsiloon)
      n2=n2/(norm2(n2,3)+epsiloon)
...
!      secangle = atan2(cos1,cos2)
      ...
      ! Angle info 2 -- cross product
      crs  = cross_product(nx,n2)
      sgn=sign(1.,dot_product(crs,geo2cart(lon1(1),lat1(1))))
      secangle=sgn*acos(cos1)
      !print '(a,4f10.4)','ll1 comp (x,y):',lon1(2)-lon1(1),lat1(2)-lat1(1)
      !print '(a,4f10.4)','ll2 comp (x,y):',lon2(2)-lon2(1),lat2(2)-lat2(1)
      !print '(a,4f10.4)','vec comp (x,y):',nx(1:2),n2(1:2)
      !print '(5f10.4)',cos1,norm2(nx,3),norm2(n2,3),sgn,secangle*180./3.14157
