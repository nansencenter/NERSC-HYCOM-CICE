...
contains
   ...
   subroutine ncvar_read(filename,varname,field,nx,ny,nrec,rec1,rec2,forcerec)
      use netcdf
      ...
      integer, optional, intent(in)              :: forcerec
     ...
     do i=1,ndims
       ...
       if (dimids(i)==rdim .or. (present(forcerec) .and. i==forcerec))  then
          !recdim=rdim
          recdim=i
          lvec=lvec*nrec
          alloc_size(i)=nrec
