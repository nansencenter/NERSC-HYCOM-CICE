...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
   ...
   real, allocatable :: ldepths(:,:),llon(:,:),llat(:,:),depths(:,:),tmp(:,:), &
      depths2(:,:)
...
! reading local files
...
#if defined (MATLAB)
   pa1=mxCreateNumericMatrix(nxl,nyl,mxClassIDFromClassName('double'),0)
   call mxCopyReal8ToPtr(io1,mxGetPr(pa1),nxl*nyl)
   iret=matPutVariable(mp, 'ldepths', pa1)
#endif
   ...
   pa1=mxCreateNumericMatrix(nxl,nyl,mxClassIDFromClassName('double'),0)
   call mxCopyReal8ToPtr(io1,mxGetPr(pa1),nxl*nyl)
   iret=matPutVariable(mp, 'llat', pa1)
   !
   pa1=mxCreateNumericMatrix(nxl,nyl,mxClassIDFromClassName('double'),0)
   call mxCopyReal8ToPtr(io2,mxGetPr(pa1),nxl*nyl)
   iret=matPutVariable(mp, 'llon', pa1)
#endif
   deallocate(io1,io2)
...
! reading global files
...
#if defined (MATLAB)
   pa1=mxCreateNumericMatrix(nxg,nyg,mxClassIDFromClassName('double'),0)
   call mxCopyReal8ToPtr(io1,mxGetPr(pa1),nxg*nyg)
   iret=matPutVariable(mp, 'gdepths', pa1)
#endif
   ...
   pa1=mxCreateNumericMatrix(nxg,nyg,mxClassIDFromClassName('double'),0)
   call mxCopyReal8ToPtr(io1,mxGetPr(pa1),nxg*nyg)
   iret=matPutVariable(mp, 'glat', pa1)
   !
   pa1=mxCreateNumericMatrix(nxg,nyg,mxClassIDFromClassName('double'),0)
   call mxCopyReal8ToPtr(io2,mxGetPr(pa1),nxg*nyg)
   iret=matPutVariable(mp, 'glon', pa1)
#endif
   deallocate(io1,io2)
...
#if defined (MATLAB)
   allocate(io1(nxl,nyl))  ; io1=tmp
   pa1=mxCreateNumericMatrix(nxl,nyl,mxClassIDFromClassName('double'),0)
   call mxCopyReal8ToPtr(io1,mxGetPr(pa1),nxl*nyl)
   iret=matPutVariable(mp, 'depths_global_to_local', pa1)
   deallocate(io1)
#endif
...
! dumping new depths file
   ...
   pa1=mxCreateNumericMatrix(nxl,nyl,mxClassIDFromClassName('double'),0)
   call mxCopyReal8ToPtr(io1,mxGetPr(pa1),nxl*nyl)
   iret=matPutVariable(mp, 'depths_final', pa1)
   iret=matclose(mp)
   print *,'depths in '//trim(matfile)//' (matlab file)'
#endif
   deallocate(io1)
