...
! Ecmwf air temperature   K 
      if (lsynairtmp) then
         ...
         if  (irec/=-1) then
            ...
            call interpug(ecmwf_tair,nlon,nlat,flon,flat,dlon,dlat, &
...
! ECMWF clouds   []  (0-1)
      if (lsynclouds) then
         ...
         if (irec/=-1) then
            ...
            call interpug(ecmwf_tcc ,nlon,nlat,flon,flat,dlon,dlat, &
...
! ECMWF winds
      if (lsynwnd) then
         ...
         if (irec2/=-1.and.irec/=-1) then
            ...
            call interpug(ecmwf_uwnd ,nlon,nlat,flon,flat,dlon,dlat, &
                             synuwind,mlon,plat,itype)   
            call interpug(ecmwf_vwnd ,nlon,nlat,flon,flat,dlon,dlat, &
...
! Pressure
      if (lsynslp) then
         ...
         if (irec/=-1) then
            ...
            call interpug(ecmwf_pres ,nlon,nlat,flon,flat,dlon,dlat, &
...
! Relative humidity
      if (lsynrelhum) then
         ...
         if (irec/=-1) then
            ...
            call interpug(ecmwf_rhum ,nlon,nlat,flon,flat,dlon,dlat, &
