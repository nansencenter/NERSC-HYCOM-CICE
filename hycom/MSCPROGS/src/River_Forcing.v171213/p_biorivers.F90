program biorivers
   ...
   !   print *,'using standard values for radii'
      ...
      print *,'river forcing fields for use with HYCOM. The rivers nutrient are'
      print *,'specified in the file biorivers.dat.'
      print *
   ...
   call ZAIOST()
   call get_grid()
   call biorivers_to_hycom(plon,plat,scpx,scpy,depths)
   print *
   print *, 'River      radius [km]: ',rradius/1000.
   print *, 'Alongshore radius [km]: ',alongshoreradius/1000.
   print *
