...
# --- awk -f 284.awk y01=098 ab=a 284M.com > 284m098a.com
C
...
C --- W is permanent native mslprs directory
C
setenv E 306
...
C
C --- For mslprs, only Y01 and A are used.
C
...
echo "TS =" $TS "TM =" $TM
C
C --- units are hPa - 1000, not Pa as indicated by the netCDF file
C
setenv YC1 `echo $Y01 | awk '{printf("%04d\n",$1+1900)}'`
setenv CDF071 cfsr-sea_${YC1}_01hr_sfcprs.nc
setenv YCX `echo $YXX | awk '{printf("%04d\n",$1+1900)}'`
setenv CDF072 cfsr-sea_${YCX}_01hr_sfcprs.nc
C
