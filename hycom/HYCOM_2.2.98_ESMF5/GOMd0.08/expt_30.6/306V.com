...
# --- awk -f 284.awk y01=098 ab=a 284V.com > 284v098a.com
C
...
setenv CDF071 cfsr-sec2_${YC1}_01hr_uv-10m.nc
setenv YCX `echo $YXX | awk '{printf("%04d\n",$1+1900)}'`
setenv CDF072 cfsr-sec2_${YCX}_01hr_uv-10m.nc
C
...
cat <<E-o-D  > fort.05in
 ...
 &WWFLAG
  ...
  ISPEED =-1,  !-1:wind velocity,none; 0:none; 1:const; 2:kara; 3:coare
  INTERP = 3,  !0:bilinear; 1:cubic spline; 3:piecewise bi-cubic
...
if (-e ../cice) then
  ...
  hycom2raw8 ../wvel/wndewd_${Y01}${A}.a ${IDM} ${JDM} 1 1 ${IDM} ${JDA} wndewd_${Y01}${A}.r >! wndewd_${Y01}${A}.B
  hycom2raw8 ../wvel/wndnwd_${Y01}${A}.a ${IDM} ${JDM} 1 1 ${IDM} ${JDA} wndnwd_${Y01}${A}.r >! wndnwd_${Y01}${A}.B
endif
C
