...
c
      ...
      save  /linepr/
c
      double precision dtim1,day,hour
      integer          iyr,nleap
c
      if     (yrflag.eq.0) then
...
c
        iyear =  1901 + iyr
        iday  =  dtime - dtim1 + 1
         hour = (dtime - dtim1 + 1.d0 - iday)*24.d0
c
      else
        write(lp,*)
