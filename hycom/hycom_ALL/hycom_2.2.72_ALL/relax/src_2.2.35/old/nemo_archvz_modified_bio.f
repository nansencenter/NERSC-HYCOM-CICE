...
C /////////////////// NOW 3D /////////////////////////////
     ...
     +     flag_t,flag_s,flag_th,flag_u,flag_v,flag_no3,
     +     flag_po4,flag_si,ISOPYC,
...
C          
     ...
     +          flag_u,flag_v,flag_no3,flag_po4,flag_si,
     +          itest,jtest,SM(I,J),TM(I,J),
     +          PU(I,J),PV(I,J),UV(:,I,J),VV(:,I,J),
     +          ldebug,sigver,TZ(:,I,J),SZ(:,I,J),
     +          NO3(:,I,J),PO4(:,I,J),SI(:,I,J),NO3M(I,J),
     +          PO4M(I,J),SIM(I,J))
...
C
     ...
     +          flag_u,flag_v,flag_no3,flag_po4,flag_si,itest,jtest,
     +          SM,TM,UM,VM,UV,VV,
     +          ldebug,sigver,TZ,SZ,NO3,PO4,SI,NO3M,PO4M,SIM)
        IMPLICIT NONE
...
C
     ...
     +     tlevel1,ARCHVFILE,cfld,MTG1,SRFH,SUFLX,SAFLX,
     +     BLDP,MIXDP,UBRTP,VBRTP,TZ,SZ,UV,VV,RZ,ZL,
     +     flag_t,flag_s,flag_th,flag_u,flag_v,flag_no3,flag_po4,
     +     flag_si,ISOPYC,
     +     SIGVER,LEVTOP,SIG3D,DEPTH,TZ1,SZ1,UV1,VV1,TH,TH1,
     +     NO3,PO4,SI)
        IMPLICIT NONE
