...
foreach m ( iso_density relax_flat_rivers relax_tracer relaxi relaxv rmu rmu2 tracer_const z_archive z_const z_levitus z_medatlas z_modify sst_pf sst_pf_4km z_woa_dynamic  )
