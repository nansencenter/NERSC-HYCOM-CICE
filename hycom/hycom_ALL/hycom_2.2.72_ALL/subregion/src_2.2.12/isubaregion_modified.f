...
c
      call xcspmd
      call zaiost
      call blkdat(idm_out,jdm_out,iscan,
     &            smooth,icegln,
...
*           endif
      ...
      subroutine landfill(a,mask,m,n, iv,if,il,jf,jl, iscan)
      use mod_za
      implicit none
c
      integer m,n,mask(m,n), iv(n,2),if,il,jf,jl, iscan, scanrange
      real    a(m,n)
c
...
!                 write(6,'(a,2i5,f5.1,2i,f10.3)') 
!     &              '   i,j,ss,  a = ',i,j,ss,a(i,j)
!                endif
cMostafa
              else
!                 write(6,'(a,i,a,i,a,i)') "Increasing nleft ",i,
!     &        " of ",j," nleft= ",nleft
...
cMostafa
!           write(6,'(a,i,a,i)') "Increasing scanrange to ",scanrange,
!     &        " of ",iscan
cMostafa
