...
c --- 'hybthk' = HYBGEN: rato of layer vs its neighbors must be > hybthk
c                 (0.0 for old behaviour; typically 0.3 to 0.5)
...
c
     ...
     &            th3d(i,j,k+1,n).gt.theta(i,j,k)+epsil      ) then
            ...
            if     (dpmid.lt.hybthk*min(dptop,dpbot)) then
c
