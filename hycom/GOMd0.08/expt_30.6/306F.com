...
setenv CDF071 cfsr-sea_${YC1}_01hr_TaqaQrQp.nc
setenv YCX `echo $YXX | awk '{printf("%04d\n",$1+1900)}'`
setenv CDF072 cfsr-sea_${YCX}_01hr_TaqaQrQp.nc
C
...
if (-e ../cice) then
  ...
  hycom2raw8 ../flux/vapmix_${Y01}${A}.a ${IDM} ${JDM} 1 1 ${IDM} ${JDA} vapmix_${Y01}${A}.r >! vapmix_${Y01}${A}.B
# airtmp is in degK
  hycom_expr ../flux/airtmp_${Y01}${A}.a ONE ${IDM} ${JDM} 1.0 273.15 airtmp_${Y01}${A}.a >! airtmp_${Y01}${A}.b
  hycom2raw8         airtmp_${Y01}${A}.a ${IDM} ${JDM} 1 1 ${IDM} ${JDA} airtmp_${Y01}${A}.r >! airtmp_${Y01}${A}.B
# netrad may not be needed, create it anyway
  hycom2raw8 ../flux/shwflx_${Y01}${A}.a ${IDM} ${JDM} 1 1 ${IDM} ${JDA} netrad_${Y01}${A}.r >! netrad_${Y01}${A}.B
