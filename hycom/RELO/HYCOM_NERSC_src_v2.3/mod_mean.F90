...
!
#if defined(NERSC_HYCOM_CICE) && defined(NETCDF_ARCHV)
! --- Can not move this into mod_netcdf_util due to circular
! --- dependencies. TODO: suggest moving mean values out of module
! --- so that  we can move this subroutine into mod_netcdf_util.
