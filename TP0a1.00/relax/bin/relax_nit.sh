...
for MM in   01 02 03 04 05 06 07 08 09 10 11 12 ; do
   ...
   ${pget} ${BASEDIR}/relax/$CLIM/nitr_sig${KSIGMA}_m${MM}.b fort.71  || { echo "Couldnt get z-climatology" ; exit 1 ;}
   ${pget} ${BASEDIR}/relax/$CLIM/nitr_sig${KSIGMA}_m${MM}.a fort.71A || { echo "Couldnt get z-climatology" ; exit 1 ;}
   ...
   # --- Output.
   #
   mv fort.10  relax_nit_m${MM}.b
   mv fort.10A relax_nit_m${MM}.a
...
#
cp relax_nit_m01.b relax.ECO_no3.b
#
for  MM  in  02 03 04 05 06 07 08 09 10 11 12 ; do
  tail -n +6 relax_nit_m${MM}.b >> relax.ECO_no3.b
done
#
cp relax_nit_m01.a relax.ECO_no3.a
#
for MM in  02 03 04 05 06 07 08 09 10 11 12 ; do
  cat relax_nit_m${MM}.a >> relax.ECO_no3.a
done
${pput} relax.ECO_no3.b ${D}/relax.ECO_no3.b
${pput} relax.ECO_no3.a ${D}/relax.ECO_no3.a
#
# --- delete the monthly files
#
/bin/rm relax_nit_m??.[ab]
#C
