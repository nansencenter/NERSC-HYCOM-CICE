...
#
cp relax_alk_m01.b relax.ECO_alk.b
#
for  MM  in  02 03 04 05 06 07 08 09 10 11 12 ; do
  tail -n +6 relax_alk_m${MM}.b >> relax.ECO_alk.b
done
#
cp relax_alk_m01.a relax.ECO_alk.a
#
for MM in  02 03 04 05 06 07 08 09 10 11 12 ; do
  cat relax_alk_m${MM}.a >> relaxalk.a
done
${pput} relax.ECO_alk.b ${D}/relax.ECO_alk.b
${pput} relax.ECO_alk.a ${D}/relax.ECO_alk.a
#
