module m_invdistibcao4
contains
subroutine invdistibcao4(deep,modlon,modlat,nocean,nland,nx,ny,&
...
! inverse distance interpolation from obscured IBCAO grid
   ...
   enddo
   enddo
end subroutine invdistibcao4
end module m_invdistibcao4
